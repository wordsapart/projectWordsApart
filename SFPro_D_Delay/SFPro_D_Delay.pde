...
void setup() {
  ...
  words = new Word[] {
    new Word("įbridęs", 500, 240, 48, new SoundFile(this, "D01_Delay.wav"), MyFont),
    new Word("vidury", 500, 300, 48, new SoundFile(this, "D02_Delay.wav"), MyFont), 
    new Word("upės", 500, 360, 48, new SoundFile(this, "D03_Delay.wav"), MyFont), 
    ...
    new Word("stovi", 500, 480, 48, new SoundFile(this, "D04_Delay.wav"), MyFont),
    new Word("žmogus", 500, 540, 48, new SoundFile(this, "D05_Delay.wav"), MyFont),
    ...
    new Word("atrodo", 500, 660, 48, new SoundFile(this, "D06_Delay.wav"), MyFont),
    new Word("niekas", 500, 720, 48, new SoundFile(this, "D07_Delay.wav"), MyFont),
    new Word("jam", 500, 780, 48, new SoundFile(this, "D08_Delay.wav"), MyFont),
    new Word("lyg", 500, 850, 48, new SoundFile(this, "D09_Delay.wav"), MyFont),
    new Word("nerūpi", 500, 900, 48, new SoundFile(this, "D10_Delay.wav"), MyFont),
    ...
    new Word("ramus", 500, 1020, 48, new SoundFile(this, "D11_Delay.wav"), MyFont),
    new Word("stovi", 500, 1080, 48, new SoundFile(this, "D12_Delay.wav"), MyFont),
    new Word("jis", 500, 1140, 48, new SoundFile(this, "D13_Delay.wav"), MyFont),
    new Word("ir", 500, 1200, 48, new SoundFile(this, "D14_Delay.wav"), MyFont),
    new Word("nejudėdamas", 500, 1260, 48, new SoundFile(this, "D15_Delay.wav"), MyFont),
    new Word("žiūri", 500, 1320, 48, new SoundFile(this, "D16_Delay.wav"), MyFont),
    ...
    new Word("kaip", 500, 1440, 48, new SoundFile(this, "D17_Delay.wav"), MyFont),
    new Word("juda", 500, 1500, 48, new SoundFile(this, "D18_Delay.wav"), MyFont),
    new Word("plūdė", 500, 1560, 48, new SoundFile(this, "D19_Delay.wav"), MyFont),
    new Word("kaip", 500, 1620, 48, new SoundFile(this, "D20_Delay.wav"), MyFont),
    new Word("plaukia", 500, 1680, 48, new SoundFile(this, "D21_Delay.wav"), MyFont),
    new Word("rūkas", 500, 1740, 48, new SoundFile(this, "D22_Delay.wav"), MyFont),
