...
void setup() {
  ...
  words = new Word[] {
    new Word("įbridęs", 500, 240, 48, new SoundFile(this, "R_01_Delay2.wav"), MyFont),
    new Word("vidury", 500, 300, 48, new SoundFile(this, "R_02_Delay2.wav"), MyFont), 
    new Word("upės", 500, 360, 48, new SoundFile(this, "R_03_Delay2.wav"), MyFont), 
    ...
    new Word("stovi", 500, 480, 48, new SoundFile(this, "R_04_Delay2.wav"), MyFont),
    new Word("žmogus", 500, 540, 48, new SoundFile(this, "R_05_Delay2.wav"), MyFont),
    ...
    new Word("atrodo", 500, 660, 48, new SoundFile(this, "R_06_Delay2.wav"), MyFont),
    new Word("niekas", 500, 720, 48, new SoundFile(this, "R_07_Delay2.wav"), MyFont),
    new Word("jam", 500, 780, 48, new SoundFile(this, "R_08_Delay2.wav"), MyFont),
    new Word("lyg", 500, 850, 48, new SoundFile(this, "R_09_Delay2.wav"), MyFont),
    new Word("nerūpi", 500, 900, 48, new SoundFile(this, "R_10_Delay2.wav"), MyFont),
    ...
    new Word("ramus", 500, 1020, 48, new SoundFile(this, "R_11_Delay2.wav"), MyFont),
    new Word("stovi", 500, 1080, 48, new SoundFile(this, "R_12_Delay2.wav"), MyFont),
    new Word("jis", 500, 1140, 48, new SoundFile(this, "R_13_Delay2.wav"), MyFont),
    new Word("ir", 500, 1200, 48, new SoundFile(this, "R_14_Delay2.wav"), MyFont),
    new Word("nejudėdamas", 500, 1260, 48, new SoundFile(this, "R_15_Delay2.wav"), MyFont),
    new Word("žiūri", 500, 1320, 48, new SoundFile(this, "R_16_Delay2.wav"), MyFont),
    ...
    new Word("kaip", 500, 1440, 48, new SoundFile(this, "R_17_Delay2.wav"), MyFont),
    new Word("juda", 500, 1500, 48, new SoundFile(this, "R_18_Delay2.wav"), MyFont),
    new Word("plūdė", 500, 1560, 48, new SoundFile(this, "R_19_Delay2.wav"), MyFont),
    new Word("kaip", 500, 1620, 48, new SoundFile(this, "R_20_Delay2.wav"), MyFont),
    new Word("plaukia", 500, 1680, 48, new SoundFile(this, "R_21_Delay2.wav"), MyFont),
    new Word("rūkas", 500, 1740, 48, new SoundFile(this, "R_22_Delay2.wav"), MyFont),
