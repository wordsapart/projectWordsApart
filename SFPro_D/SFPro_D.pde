...
void setup() {
  ...
  words = new Word[] {
    new Word("įbridęs", 500, 240, 48, new SoundFile(this, "D01.wav"), MyFont),
    new Word("vidury", 500, 300, 48, new SoundFile(this, "D02.wav"), MyFont), 
    new Word("upės", 500, 360, 48, new SoundFile(this, "D03.wav"), MyFont), 
    ...
    new Word("stovi", 500, 480, 48, new SoundFile(this, "D04.wav"), MyFont),
    new Word("žmogus", 500, 540, 48, new SoundFile(this, "D05.wav"), MyFont),
    ...
    new Word("atrodo", 500, 660, 48, new SoundFile(this, "D06.wav"), MyFont),
    new Word("niekas", 500, 720, 48, new SoundFile(this, "D07.wav"), MyFont),
    new Word("jam", 500, 780, 48, new SoundFile(this, "D08.wav"), MyFont),
    new Word("lyg", 500, 850, 48, new SoundFile(this, "D09.wav"), MyFont),
    new Word("nerūpi", 500, 900, 48, new SoundFile(this, "D10.wav"), MyFont),
    ...
    new Word("ramus", 500, 1020, 48, new SoundFile(this, "D11.wav"), MyFont),
    new Word("stovi", 500, 1080, 48, new SoundFile(this, "D12.wav"), MyFont),
    new Word("jis", 500, 1140, 48, new SoundFile(this, "D13.wav"), MyFont),
    new Word("ir", 500, 1200, 48, new SoundFile(this, "D14.wav"), MyFont),
    new Word("nejudėdamas", 500, 1260, 48, new SoundFile(this, "D15.wav"), MyFont),
    new Word("žiūri", 500, 1320, 48, new SoundFile(this, "D16.wav"), MyFont),
    ...
    new Word("kaip", 500, 1440, 48, new SoundFile(this, "D17.wav"), MyFont),
    new Word("juda", 500, 1500, 48, new SoundFile(this, "D18.wav"), MyFont),
    new Word("plūdė", 500, 1560, 48, new SoundFile(this, "D19.wav"), MyFont),
    new Word("kaip", 500, 1620, 48, new SoundFile(this, "D20.wav"), MyFont),
    new Word("plaukia", 500, 1680, 48, new SoundFile(this, "D21.wav"), MyFont),
    new Word("rūkas", 500, 1740, 48, new SoundFile(this, "D22.wav"), MyFont),
